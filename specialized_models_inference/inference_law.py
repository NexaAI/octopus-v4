...
def prompt_format(user_query):
    system_prompt = "You are an expert in law, skilled in constitutional law, criminal law, corporate law, and international law."
...
if __name__ == "__main__":
    prompt = "Analyze the impact of recent changes in international law on global trade agreements."
    subject = "law"
